...
class RoutesManager{
  ...
  static final GoRouter routes = GoRouter(
    routes: [
      GoRoute(
        path: home,
        builder: (context, state) => MarkdownHomeScreen(),
      ),
      GoRoute(
        path: editor,
        builder: (context, state) => MarkdownEditorScreen(noteDataModel: state.extra as NoteDataModel?,)
      ),
      GoRoute(
        path: settings,
      ...
      GoRoute(
        path: preview,
        builder: (context, state) => MarkdownFullPreviewScreen(note: state.extra as NoteDataModel,)
      ),
    ]
  );
}